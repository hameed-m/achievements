...
export const achievements = [
  {
    ...
    cardDetailedText:
      "Created 'Transfer to Ship,' 'Transfer to Receive,' and 'Check Transfer Order' modules for efficient inventory movement.",
  ...
  },
  {
    ...
    cardDetailedText:
      "Built intuitive user interfaces (React Native) and robust backend architecture (Node.js, Fastify) for rewards tracking and redemption.",
  ...
  },
  {
    ...
    cardDetailedText:
      "Aided in data updates, resolved usage issues, and supported colleagues during transition phases.",
  ...
  },
  {
    ...
    cardDetailedText:
      "Drove technical improvements with a focus on scalability and seamless online ordering.",
